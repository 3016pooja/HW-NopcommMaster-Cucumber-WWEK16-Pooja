...
public class RegisterPage extends Utility {
    ...
    public void selectdayofbirth() {
        ...
        clickOnElement(day);
        selectByVisibleTextFromDropDown(day, " //select[@name='DateOfBirthDay']/option[6]");
    ...
    public void selectmonthofbirth() {
        ...
        selectByVisibleTextFromDropDown(month, "//select[@name='DateOfBirthMonth']/option[6]");
    ...
    public void selectyearofbirth() {
        ...
        clickOnElement(year);
        selectByVisibleTextFromDropDown(year, " //option[contains(text(),'2005')]");
    }
